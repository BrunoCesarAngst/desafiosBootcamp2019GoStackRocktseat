/** Nesse arquivo configura-se o servidor express e utizamos classes, pois,
 * faz todo o sentido por estarmos dando nome as coisas. */
...
// só isso
import './database';
// para testarmos vamos no arquivo routes.js para aimportação do usuário
